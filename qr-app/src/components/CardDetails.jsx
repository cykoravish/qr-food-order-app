...
export const CardDetails = ({ dishName, price, category, id, onAddToCart, image, product, css }) => {
    ...
    console.log(product)
    return (
        <div className={` min-w-[100px]  flex flex-col justify-center shadow-md hover:scale-105 ${css}`} >
            ...
            <button className='bg-yellow-300 min-w-[70px] px-1 h-10 flex justify-center items-center rounded-md mt-2' onClick={() => onAddToCart(category, id, price)}>Add to cart</button>
        </div >
